import type { SocialPlatform } from '@/types/hero'

/**
 * Inline SVG per platform — deliberately not stored in Sanity, so the card's
 * social buttons never wait on an image request.
 */
...
/**
 * The card always reads top-to-bottom GitHub → LinkedIn → email regardless of
 * the order the links were entered in Studio, so the stack never reshuffles.
 */
export const SOCIAL_ORDER: SocialPlatform[] = ['github', 'linkedin', 'x', 'email']
